$(document).ready(function() {
    //Making an array for all countries.
...
// When the user clicks on the button, open the modal 
     ...
     const formSubmitHandler = $(".btn").on("click" , function(event) {
         event.preventDefault();
        var InputEl = $('input[name=city]').val();
        for( var i = 0; i < COUNTRIES.length; i++){
            if ( InputEl === COUNTRIES[i].name) {
                const code = COUNTRIES[i].code
                console.log("yes")
    
                var apiUrl = 'https://www.travel-advisory.info/api?countrycode='+code+'';
               ...
               var message = data.data[code].advisory.message;
                 $('#message').append('<p/>Advisory level:<p/>',message);  
